...
@Component({
   ...
   template: `
      ...
      >
         <div class="px-6">
            <app-card-input-form title="Add Breeze Card" />

            <button class="btn btn-primary w-full my-8">Add Breeze Card</button>
...
export class SavedCardModalComponent {
