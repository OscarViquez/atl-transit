export enum EndpointResponse {
   ...
   STATION_SCHEDULE_RESPONSE = 'https://atl-transit-community-proxy.cyclic.app/api/get/stationschedule/'
}
...
export enum DevEndPointResponse {
   ...
   STATION_SCHEDULE_RESPONSE = 'http://localhost:3000/api/get/stationschedule/'
}
