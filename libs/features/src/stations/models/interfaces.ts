...
/**
 * * StationDetailsArrival is an interface that defines the structure of a station arrival object.
 * @property id - A unique identifier for the station. This can be used for storing or saving the station in a database.
 * @property header - An object of type `Header` that contains the name and description of the station.
 * @property arrivals - An array of `StationArrivalItem` objects. Each `StationArrivalItem` object contains information about a train arrival, such as the arrival time and status.
 */
 ...
 * @property nearest - will contain data for stations near to the user OR if location is disabled, it will contain the 2 default stations.
...
/**
 * StationArrivalItem is an interface that defines the structure of a train arrival slot at a station.
...
export interface StationBusRoute {
   header: Header;
   routes: BusRoutesItem[];
}

/**
 * BusRoutesItem is an interface that defines the structure of a bus route at a station.
